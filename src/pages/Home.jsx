  ...
  const places = [
    {
      ...
      directions: "https://www.google.com/maps/dir//Mondrian+Suites+Berlin+am+Checkpoint+Charlie,+Markgrafenstraße+16%2F16a,+10969+Berlin/",
      type: "Luxury",
      distance: "3 min walk",
    },
    {
      ...
      directions: "https://www.google.com/maps/dir//Adina+Apartment+Hotel+Berlin+Checkpoint+Charlie,+Krausenstraße+35-36,+10117+Berlin/",
      type: "Luxury",
    ...
    },
    {
      ...
      directions: "https://www.google.com/maps/dir//acama+Hotel+%26+Hostel+Kreuzberg,+Tempelhofer+Ufer+8%2F9,+10963+Berlin/",
      type: "Budget",
    ...
    },
    {
      ...
      directions: "https://www.google.com/maps/dir//36+Rooms+Hostel+Berlin,+Spreewaldplatz+8,+10999+Berlin/",
      type: "Budget",
    ...
    },
    {
      ...
      directions: "https://www.google.com/maps/dir//Hilton+Berlin,+Mohrenstraße+30,+10117+Berlin/",
      type: "Luxury",
      distance: "15 min walk",
    },
    {
      ...
      directions: "https://www.google.com/maps/dir//Select+Hotel+Berlin+Checkpoint+Charlie,+Hedemannstraße+11-12,+10969+Berlin/",
      type: "Mid-range",
      distance: "4 min walk",
    },
    {
      ...
      directions: "https://www.google.com/maps/dir//NH+Collection+Berlin+Mitte+am+Checkpoint+Charlie,+Leipziger+Str.+106-111,+10117+Berlin/",
      type: "Luxury",
      distance: "6 min walk",
    },
    {
      ...
      directions: "https://www.google.com/maps/dir//Hotel+Gat+Point+Charlie,+Mauerstraße+81–82,+10117+Berlin/",
      type: "Mid-range",
      distance: "5 min walk",
    },
    {
      ...
      directions: "https://www.google.com/maps/dir//Novotel+Suites+Berlin+City+Potsdamer+Platz,+Anhalter+Str.+2,+10963+Berlin/",
      type: "Mid-range",
      distance: "9 min walk",
    },
    {
      ...
      directions: "https://www.google.com/maps/dir//ibis+Berlin+City+Potsdamer+Platz,+Anhalter+Str.+4,+10963+Berlin/",
      type: "Budget",
      distance: "8 min walk",
    },
    {
      ...
      directions: "https://www.google.com/maps/dir//relexa+hotel+Stuttgarter+Hof,+Anhalter+Str.+8-9,+10963+Berlin/",
      type: "Mid-range",
      distance: "9 min walk",
    },
    {
      ...
      directions: "https://www.google.com/maps/dir//M%C3%B6venpick+Hotel+Berlin,+Sch%C3%B6neberger+Str.+3,+10963+Berlin/",
      type: "Luxury",
      distance: "10 min walk",
    },
    {
      ...
      directions: "https://www.google.com/maps/dir//Check+In+Hostel+Berlin,+Markgrafenstra%C3%9Fe+68,+10969+Berlin/",
      type: "Budget",
      distance: "2 min walk",
    },
    {
      ...
      directions: "https://www.google.com/maps/dir//MEININGER+Hotel+Berlin+Mitte,+Oranienburger+Str.+67%2F68,+10117+Berlin/",
      type: "Budget",
      distance: "15 min walk",
    },
  ];
    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex-grow py-12 px-4 md:px-12">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-8">
          ...
          <div className="flex-1 flex flex-col gap-6">
            <div className="bg-gray-900 rounded-3xl p-8 shadow-2xl text-white transform hover:scale-102 transition-transform duration-300">
              <h2 className="text-3xl md:text-4xl font-bold mb-3 text-yellow-400 drop-shadow">
                Convention 2026
              </h2>
              <p className="text-base md:text-lg mb-6 opacity-90 italic">
                Theme: “Preserving Heritage & Navigating Modernity in the Diaspora”
              </p>
              <ul className="space-y-3 text-base md:text-lg mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                ...
                <div key={index} className="bg-gray-800 p-6 rounded-2xl shadow-lg hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 text-white">
                  <h3 className="text-xl font-bold text-yellow-400 mb-2">{ticket.title}</h3>
                  <p className="text-lg font-semibold mb-1">{ticket.price}</p>
                  <p className="text-sm text-gray-300">{ticket.period}</p>
                </div>
              ))}
            </div>
            ...
            {/* Contact Info */}
            <div className="bg-gray-900 rounded-3xl p-8 shadow-2xl text-white transform hover:scale-102 transition-transform duration-300">
              <h3 className="text-2xl font-semibold mb-3 underline text-yellow-400 drop-shadow">
                Contact Information
              </h3>
          ...
          {/* Payment Methods */}
          <div className="flex-1 bg-gray-800 rounded-3xl p-8 shadow-2xl text-white transform hover:scale-102 transition-transform duration-300">
            <h2 className="text-3xl md:text-4xl font-bold mb-3 text-yellow-400 drop-shadow">
              Payment Methods
            </h2>
            ...
            <ul className="space-y-6 text-base md:text-lg">
              ...
              <li className="bg-gray-700 p-4 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                ...
                <span className="text-yellow-400 text-xs">Request a Tikkie from Margret: +31 681 941613</span>
              </li>   
              {/* Mobile Money */}
              <li className="bg-gray-700 p-4 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                ...
                <div className="mt-4">
                  <a
                    ...
                    className="inline-block px-6 py-3 bg-yellow-400 text-indigo-900 font-bold rounded-full shadow-lg hover:opacity-90 transform hover:scale-105 transition-all duration-300"
                  >
                    Register Now
                  </a>
                </div>
      ...
      <section className="bg-gray-50 py-16 px-4 md:px-12">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-extrabold text-center mb-6 text-indigo-900 drop-shadow">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredPlaces.map((hotel, index) => (
              <div
                key={index}
                className="bg-white rounded-3xl shadow-lg hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 p-6"
              >
